...
SECRET_KEY = 'django-insecure-%drqx^z4*hfx28kd!_^0h+hbzmzk=sgcsa!)jxih28p#o)a#5='
...
# pymysql 연동
import pymysql
pymysql.version_info = (1, 4, 2, "final", 0) # 장고 버전과 호환성 유지하기 위한 방법
...
AWS_DEFAULT_ACL = 'public-read' # 파일을 어떤 권한으로 올릴 것인가? 일반 사용자가 파일 볼 수 있도록
AWS_LOCATION = 'static' # 버킷 내부의 어느 위치에 넣으 것인가?

#STATIC_URL = '/static/'
STATIC_URL = f'http://{AWS_S3_CUSTOM_DOMAIN}/{AWS_LOCATION}/'
STATICFILES_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage' # 로컬에 저장 방지, 위에서 설정한 S3로 저장하도록 설정함
